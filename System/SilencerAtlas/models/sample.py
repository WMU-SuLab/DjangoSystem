...
class Sample(Base):
    ...
    sample_id = models.CharField(max_length=128, default='--', null=True, blank=True, db_index=True,
                                 verbose_name='样本的id')
    bio_sample_name = models.CharField(max_length=255, default='--', db_index=True, unique=True, verbose_name='样本名称')
